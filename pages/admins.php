...
<body id="mylist">
    ...
    <section id="sidebar">
        <ul>
            ...
            <li><a href="../pages/admins.php" class="active"><i class="fa-solid fa-user-tie"></i>Admins</a></li>
    ...
    <div id="wholeListing">
        ...
        <section class="section-p1">
            <div id="myListing">
                <div id="heading">
                    <h1>All Admins</h1>
                    <button class="normal" onclick="window.location.href='../pages/addAdmins.php'">
                        <i class="fa-solid fa-plus"></i> Add Admins
                    </button>
                </div>
                <p>Manage all Admins on the platform</p>
