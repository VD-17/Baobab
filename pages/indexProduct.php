        ...
        <?php if (count($result) > 0): ?>
            <?php foreach ($result as $row): ?>
                <div class="pro" data-product-id="<?php echo $row['id']; ?>">
                    ...
                    <div class="product-image" onclick="viewSingleProduct(<?php echo $row['id']; ?>)">
                    ...
                    <div class="des">
                        <div class="des1">
                            ...
                            <h5 class="product-name" onclick="viewSingleProduct(<?php echo $row['id']; ?>)">
                        ...
                        <div class="des2">
                            <div class="product-actions">
                                ...
                                <?php if (isset($_SESSION['userId'])): ?>
                                    <form action="pages/indexAdd_to_cart.php" method="POST" class="inline-form">
